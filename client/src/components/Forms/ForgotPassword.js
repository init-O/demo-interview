...
const ForgotPassword = ({isLogin,setIsLogin, isModal,setOpen}) => {
                    ...
                    <form class="space-y-6" action="#">
                        {isModal ? 
                            <div className="flex justify-between">
                                ...
                                <button  onClick={handleCloseModal} className="text-black hover:bg-red-800 rounded-full">
                                        <CloseRounded/>
                                </button>
                            </div>:
                                <h3 class="text-xl font-medium text-gray-900 dark:text-white">Forgot Password</h3>
                        ...
                        {error && <div>
                            <div class="w-fill bg-red-300 flex p-3 pl-3 bg-gray-100  rounded-lg">
                                <button onClick={handleCloseError} className="text-black hover:bg-red-400 rounded">
                                    <CloseRounded/>
                                </button>
